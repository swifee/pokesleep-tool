...
import type { SerializedTeam } from "../types/TeamTimelineTypes";
import type { PokemonSwap } from "../types/TimeSlotTypes";
...
const PRESET_POKEMON_DEFINITIONS: Record<
	PresetPokemonKey,
	PresetPokemonDefinition
> = {
	pikachu: {
		id: 1000001,
