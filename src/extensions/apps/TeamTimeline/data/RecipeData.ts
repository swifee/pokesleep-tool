import { CookingCategory, RecipeDefinition } from '../types/CookingTypes';
 ...
 */
export function getRecipesByCategory(category: CookingCategory): readonly RecipeDefinition[] {
