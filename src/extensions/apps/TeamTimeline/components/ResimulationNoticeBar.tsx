						...
						{isResultMode ? (
							<>
								<Box sx={{ flex: 1, minWidth: 0 }}>
									...
									>
										{`${t("TeamTimeline.resimulation result total label", "total")} ${Math.round(
											deltaSummary.averageTotalEP,
										).toLocaleString()}EP (${formatSignedValue(deltaSummary.totalDeltaEP)})`}
									</Typography>
									<Typography
										component="div"
								...
								>
									...
									<Button
										...
										sx={{
											...
											whiteSpace: "nowrap",
											background:
												"linear-gradient(180deg, #4e8ce8 0%, #176eee 100%)",
										}}
									>
							...
							<>
								...
								>
									{t(
										"TeamTimeline.resimulation changed notice",
										"メンバー編成が変更されました。",
									)}
								</Typography>
								<Button
